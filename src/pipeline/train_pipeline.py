...
class TrainingPipeline:
    ...
    def run_pipeline(self):
        ...
        try:
            ...
            print("  • imgs/model/performance/confusion_matrix.png")
            print("  • imgs/model/performance/actual_vs_predicted.png")
            print("  • imgs/model/performance/per_class_metrics.png")
            print("  • imgs/model/performance/feature_importance.png")
            print("  • imgs/model/performance/overall_metrics.png")
            print("  • imgs/model/performance/precision_recall_curve.png")
            print("  • imgs/model/performance/prediction_probability_distribution.png")
            print("  • imgs/model/performance/actual_vs_predicted_scatter.png")
